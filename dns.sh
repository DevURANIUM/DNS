...
#<div class="customer-shell"><header><div class="brandline"><span class="brandmark" aria-hidden="true">DNS</span><div><small>DNS</small><span>پنل اتصال شما</span></div></div></header>
#<main class="card">%s</main><footer class="footer-note">DNS · اتصال، ساده‌تر از همیشه</footer></div>%s</body></html>"""
...
#<div class="card"><div class="brandline"><span class="brandmark" aria-hidden="true">DNS</span><small>DNS</small></div><h2>به پنل مدیریت خوش آمدید</h2><p class="muted">سرویس‌ها، کاربران و اتصال‌ها؛ همه در یک نگاه.</p>%s
...
#        receipts = STORE.one("SELECT count(*) c FROM transactions WHERE status = 'pending'")["c"]
...
#                (receipts, "رسید در انتظار بررسی", "receipts")):
