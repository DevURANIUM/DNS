...
#            display_name = (r["first_name"] or "").strip()
#            secondary = ("<span class='user-display-name'><bdi>%s</bdi></span>" % html.escape(display_name)
#                         if display_name and display_name.casefold() != username.strip().casefold() else "")
#            out.append(
#                "<tr><td class='user-identity' style='min-width:160px;text-align:right'>"
#                "<bdi class='user-login' style='display:block;font-size:15px;font-weight:700'>%s</bdi>%s</td>"
...
#                % (html.escape(username), secondary,
