...
#                "<td class='user-template'><form method='post' action='/%s/user-template'>"
#                "<input type='hidden' name='id' value='%d'>"
#                "<span class='template-select'><select name='template_id' aria-label='قالب کاربر' onchange='this.form.submit()'>%s</select></span>"
#                "</form></td>"
#                "<td class='%s'>%s</td>"
